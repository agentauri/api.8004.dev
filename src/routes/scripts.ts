/**
 * Scripts endpoint for MCP setup and utilities
 ...
 */
const MCP_SETUP_SCRIPT = `#!/bin/bash
...
/**
 * GET /mcp-setup
 * Returns the MCP setup script for Claude Desktop configuration
 *
 * Usage:
 *   curl -fsSL https://api.8004.dev/mcp-setup | bash
 */
scripts.get('/mcp-setup', (_c) => {
  return new Response(MCP_SETUP_SCRIPT, {
    headers: {
